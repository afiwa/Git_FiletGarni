$(document).ready(function(){
  $(".tousLesAvisConso").each(function(){
    var This = $(this) ;
    var Nums = This.find(".unAvisConso").size() ;
    This.find(".unAvisConso:first").addClass("PanelAct");
    This.append("<div class='control'></div>") ;
    This.find(".unAvisConso").not(".PanelAct")
      .css("left","100%")
    for ( i=0 ; i<Nums ; i++) {
